...
class spec extends atoum\test
{
	...
	{
		return parent::__construct($adapter, $annotationExtractor, $asserterGenerator, $assertionManager, $reflectionClassFactory); // TODO: Change the autogenerated stub
	}
	...
	public function setAssertionManager(test\assertion\manager $assertionManager = null)
	{
		...
		parent::setAssertionManager($assertionManager)
			->getAssertionManager()
				->setHandler('invoking', function($method = null) use (& $asserter) {
						if ($asserter === null)
						{
							$asserter = new asserters\invoking($this->getAsserterGenerator());
